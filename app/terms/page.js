        ...
        <div className="glass rounded-2xl p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Dengan mengakses dan menggunakan LingoSpace Pro, Anda setuju untuk terikat dengan Terms of Service ini. 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li>Quiz dan latihan interaktif</li>
              <li>Fitur listen & learn untuk pronunciation</li>
              <li>Progress tracking dan SRS (Spaced Repetition System)</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li>Menggunakan bot, spider, atau automated system</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li>Audio clips dan digital downloads</li>
              <li>Software dan source code</li>
              <li>Struktur dan organisasi website</li>
            </ul>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-purple-300">6. Disclaimer</h2>
            <p className="text-gray-300 mb-4">
              LingoSpace Pro disediakan "sebagaimana adanya" tanpa jaminan apapun. Kami tidak menjamin:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              <li>Layanan akan selalu tersedia dan error-free</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li>Hilangnya data atau profit</li>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Website ini menggunakan Google AdSense untuk menampilkan iklan. Dengan menggunakan layanan ini, 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              <li>Anda melanggar Terms of Service ini</li>
              <li>Ada aktivitas mencurigakan atau fraudulent</li>
              <li>Atas kebijakan kami sendiri</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-purple-300">10. Perubahan Terms of Service</h2>
            <p className="text-gray-300 mb-4">
              Kami dapat mengubah Terms of Service ini kapan saja. Perubahan akan efektif segera setelah diposting di halaman ini. 
              Penggunaan berkelanjutan Anda terhadap layanan setelah perubahan merupakan penerimaan Anda terhadap Terms yang baru.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Terms of Service ini diatur oleh dan sesuai dengan hukum Indonesia. 
              Setiap sengketa akan diselesaikan di pengadilan yang berwenang di Indonesia.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-purple-300">12. Kontak</h2>
            <p className="text-gray-300 mb-4">
